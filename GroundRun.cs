...
namespace SORAKAKE.Ver1
{
    class GroundRun
    {
        ...
        public void Action(ref Vector3 cameraPos, ref Vector3 cameraFront, ref Vector3 cameraRight, ref Vector3 cameraUp, ref float speed, ref KeyboardState keyboardState, ref int skygameFlag,OBJECT[] objects,int OB_MAX,OBJECT player)
        {
